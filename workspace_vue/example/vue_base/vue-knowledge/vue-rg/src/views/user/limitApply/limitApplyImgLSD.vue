                ...
                <div>
                        ...
                        <Form ref="editFormListAdd" :label-width="200">
                            ...
                            <dl class="apply-detail  applyUImg mt10 setAlls">
                                ...
                                <dd style="padding-top: 20px">
                                    ...
                                    <Row class="margin-top-10">
                                        <Col span="24">
                                            <FormItem label="实际控制人房产证/车辆行驶证/财产证明(三选一):" prop="houseDrivingPropertyUrl">
                                                <file-upload-apply
                                                        ref="upload11"
                                                        refUpload="upload11"
                                                        action="/api-webbff/v1/asset/uploadAll"
                            ...
                            <div class="Agreements">
                                <FormItem label="" class="Agreement">
                                    <span @click="agreementApply"><Checkbox v-model="agreements">已同意</Checkbox></span>
                                    <span @click="agreementPing">《药金融信息服务平台服务协议》</span><span @click="agreementShang">《商家授权协议》</span><span
                                        @click="agreementApply">《医保数据查询授权书》</span>
                                </FormItem>
                            </div>
                        </Form>
                    </div>
                    <Row>
                        <Col span="24" class="saveBntStyle">
                            ...
                            <Button type="primary" @click="validatePassLsd()" :disabled="btnDisabled">立即申请</Button>
                        </Col>
                    </Row>
                </div>
            </Card>
            ...
            * */
            ...
            validateImgLsd ()  {
                return new Promise((resolve, reject) => {
                    ...
                    if ((vm.$refs.upload7.newListqny.length === 0)&&((vm.getEntTypeLsds === '1' && vm.getClassifications === 3)||(vm.getEntTypeLsds==='2'))) {
...
// WEBPACK FOOTER //
// src/views/user/limitApply/limitApplyImgLSD.vue