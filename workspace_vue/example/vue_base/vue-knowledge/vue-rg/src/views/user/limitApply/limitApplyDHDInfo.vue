                ...
                <Card :dis-hover="true" :bordered="false">
                    ...
                    <Form ref="editFormList" :model="editFormList" :label-width="160" :rules="ruleValidate">
                        <dl class="apply-detail margin-top-20">
                            <dt><span>企业基本信息</span></dt>
                            <dd>
                                <Row>
                                    <Row>
                                        <Col span="12">
                                            <FormItem  label="企业类型："  prop="radio">
                                                {{editFormList.enterpriseTypeDesc}}
                                            </FormItem>
                                        </Col>
                                        <Col span="12">
...
<script>
    ...
    let vm = null;
    export default {
        name: "user-center-limitApplyDHDInfo",
        data() {
            return {
                modalDHD: false,
                creditCodeShow: true,
                        ...
                        if (res.data.success === 1) {
                            ...
                            if (lsdGetInfo !== '0') {
                                ...
                                if (!arr.includes(lsdGetInfo.enterpriseType)) {
                                    vm.editFormList.enterpriseTypeDesc = lsdGetInfo.enterpriseTypeDesc; // 企业类型
                                }
                                ...
                                if (!arr.includes(lsdGetInfo.provice)) {
                                    vm.editFormList.enterpriseAddressProvince = lsdGetInfo.provice; // 企业所在位置省编码
                                    vm.editFormList.enterpriseAddressCity = lsdGetInfo.city; // 企业地址市
                                    vm.editFormList.enterpriseAddressCountry = lsdGetInfo.area; // 企业地址区
                                }
...
// WEBPACK FOOTER //
// src/views/user/limitApply/limitApplyDHDInfo.vue