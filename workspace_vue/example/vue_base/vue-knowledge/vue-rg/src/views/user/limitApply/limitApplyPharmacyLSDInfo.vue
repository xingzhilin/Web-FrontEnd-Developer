                                    ...
                                    <Row>
                                        <Col span="12">
                                            <FormItem class='displayStyle' label="药店成立日期：" prop="pharmacyCreateTime">
                                                {{editFormListPharmacy.pharmacyCreateTime}}
                                            </FormItem>
                                        </Col>
                                        <Col span="12">
                                            <FormItem class='displayStyle' label="门店面积：" prop="shopAre">
                                                {{editFormListPharmacy.shopAre}} 平方米
                                            </FormItem>
                                        </Col>
                                    </Row>
                                    <Row>
                                        <Col span="12">
                                            <FormItem class='setAll displayStyle' label="经营场所是否为购得：">
                                                <div v-if="editFormListPharmacy.useplaceIsSelf === '0'">
                                                    否
                                                </div>
                                                <div v-else>
                                                    是
                                        ...
                                        <Col span="12">
                                            <FormItem label="租赁合同到期日：" v-show="leaseTimeShow" class="displayStyle setAll">
                                                {{editFormListPharmacy.leaseTime}}
                                            </FormItem>
                                        </Col>
                                    </Row>
                                    <Row>
                                        <Col span="12">
                                            <FormItem v-show="getEntTypeLsds !== '2'" label="法人名下是否有房产："
                                                ...
                                                <div v-if="editFormListPharmacy.legalHasHouse === '0'">
                                                    否
                                                </div>
                                                <div v-else>
                                                    是
                                        ...
                                        <Col  span="12">
                                            <FormItem class='displayStyle' label="医保近3个月回款金额：" prop="yearReturnMoney">
                                                {{editFormListPharmacy.yearReturnMoney}} 万元
                                            </FormItem>
                                        </Col>
                                    </Row>
                                    <Row>
                                        <Col span="12">
                                            <FormItem v-show="getEntTypeLsds !== '2'" label="法人名下是否有车辆："
                                                      class="displayStyle setAll">
                                                <div v-if="editFormListPharmacy.legalHasCar === '0'">
                                                    否
                                                </div>
                                                <div v-else>
                                                    是
                                        ...
                                        <Col span="12">
                                            <FormItem label="车辆购买日期：" v-show="buyCarTimeShow&&(getEntTypeLsds !== '2')"
                                                      class="displayStyle setAll">
                                                {{editFormListPharmacy.buyCarTime}}
                                            </FormItem>
                                        </Col>
                                    </Row>
                                ...
                                <Row class="margin-top-20">
                                    <Col span="12">
                                        <FormItem class='displayStyle' label="票据寄送人职务：" prop="billPersonPost">
                                            {{editFormListPharmacy.billPersonPost}}
                                        </FormItem>
                                    </Col>
                                    <Col span="12">
                                        <FormItem class='displayStyle' label="票据寄送人邮箱：" prop="billPersonEmail">
                                           {{editFormListPharmacy.billPersonEmail}}
                                        </FormItem>
                                    </Col>
                                </Row>
                                <Row>
                                    <Col span="12">
                                        <FormItem class='displayStyle' label="票据寄送人传真：" prop="billPersonFax">
                                            {{editFormListPharmacy.billPersonFax}}
                                        </FormItem>
                                    </Col>
                                    <Col span="12">
                                        <FormItem class='displayStyle' label="票据寄送人邮编：" prop="billPersonZipcode">
                                            {{editFormListPharmacy.billPersonZipcode}}
                                        </FormItem>
                                    </Col>
                                </Row>
                                <Row>
                                    <Col span="24">
                                        <FormItem label="票据寄送地址：" prop="billProviceCode">
                                            {{editFormListPharmacy.billAddressDetils}}
                                            {{editFormListPharmacy.billAddress}}
                                        </FormItem>
                                    </Col>
                                </Row>
                            </Card>
                                    ...
                                    vm.getAdressInfoAll(lsdGetInfo.billProviceCode, 'listCitiesTwo').then(res => {
                                        if (!arr.includes(lsdGetInfo.billCityCode)) {
                                            ...
                                            vm.getAdressInfoAll(lsdGetInfo.billCityCode, 'listDistrictsTwo').then(res => {
                                                ...
                                                vm.$nextTick(()=>{
                                                    let provinceStr = publicMethod.addressName(vm.listProvinceTwo,lsdGetInfo.billProviceCode);
                                                    let cityStr = publicMethod.addressName(vm.listCitiesTwo,lsdGetInfo.billCityCode);
                                                    let area = ''
                                                    if (!arr.includes(lsdGetInfo.billAreaCode)) {
                                                        area = publicMethod.addressName(vm.listDistrictsTwo,lsdGetInfo.billAreaCode);
                                                    }
                                                    vm.editFormListPharmacy.billAddressDetils = provinceStr + cityStr + area;
                                                });
...
// WEBPACK FOOTER //
// src/views/user/limitApply/limitApplyPharmacyLSDInfo.vue