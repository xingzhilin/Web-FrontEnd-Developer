            ...
            <Card :dis-hover="true" :bordered="false">
                <div>
                    <Form ref="editFormListLegal" :model="editFormListLegal" :label-width="220"
                                ...
                                <Row>
                                    <Col span="12">
                                        <FormItem class='displayStyle' label="法人手机：" prop="legalIphone">
                                            {{editFormListLegal.legalIphone}}
                                        </FormItem>
                                    </Col>
                                    <Col span="12">
                                        <FormItem class='displayStyle' label="法人邮箱：" prop="legalEmail">
                                            {{editFormListLegal.legalEmail}}
                                        </FormItem>
                                    </Col>
                                </Row>
                                ...
                                <Row>
                                    <Col span="24">
                                        <FormItem label="法人联系地址：" prop="legalProvinceCode">
                                            {{editFormListLegal.legalAddressDetils}}{{editFormListLegal.legalAddress}}
                                        </FormItem>
                                    </Col>
                                </Row>
                                <Row>
                                ...
                                <Row>
                                    <Col span="24">
                                        <FormItem label="法人紧急联系人电话：" prop="mobile">
                                            {{editFormListLegal.urgencyPhoneNo}}
                                        </FormItem>
                                    </Col>
                                </Row>
                                <Row>
                                    <Col span="24">
                                        <FormItem label="法人紧急联系人地址：">
                                            {{editFormListLegal.urgencyAddressDetils}}
                                            {{editFormListLegal.urgencyAddress}}
                                        </FormItem>
                                    </Col>
                                </Row>
                            </Card>
                        ...
                        <!-- 实际控制人 S -->
                        <Card :dis-hover="true" :bordered="false">
                            <Card :dis-hover="true" :padding="0" class="margin-top-10">
                                <p slot="title" style=" color: #333; font-size: 14px;">企业实际控制人信息</p>
                                <Row style="padding-top: 25px;">
                                    <Col span="24">
                                        <FormItem  label="实际控制人与法人是否为同一人："  prop="same">
                                            <div v-if="editFormListLegal.same == '0'">
                                                否
                                            </div>
                                            <div v-else>
                                                是
                                    ...
                                    <Col span="12">
                                        <FormItem class='displayStyle' label="实际控制人姓名：" prop="actualControllerName">
                                            {{editFormListLegal.actualControllerName}}
                                        </FormItem>
                                    </Col>
                                    <Col span="12">
                                        <FormItem class='displayStyle' label="实际控制人身份证号：" prop="actualIdCardNo">
                                            {{editFormListLegal.actualIdCardNo}}
                                        </FormItem>
                                    </Col>
                                </Row>
                                <Row>
                                    <Col span="12">
                                        <FormItem class='displayStyle' label="实际控制人手机：" prop="actualPhoneNo">
                                            {{editFormListLegal.actualPhoneNo}}
                                        </FormItem>
                                    </Col>
                                    <Col span="12">
                                        <FormItem label="实际控制人联系地址：" prop="actualAddress">
                                            {{editFormListLegal.actualAddressDetils}}
                                            {{editFormListLegal.actualAddress}}
                                        </FormItem>
                                    </Col>
                                </Row>
                                <Row>
                                    <Col span="12">
                                        <FormItem class='displayStyle' label="实际控制人紧急联系人姓名：" prop="actualUrgencyName">
                                            {{editFormListLegal.actualUrgencyName}}
                                        </FormItem>
                                    </Col>
                                    <Col span="12">
                                        <FormItem label="实际控制人紧急联系人电话：" prop="actualUrgencyPhoneNo">
                                            {{editFormListLegal.actualUrgencyPhoneNo}}
                                        </FormItem>
                                    </Col>
                                </Row>
                                <Row>
                                    <Col span="24">
                                        <FormItem class='displayStyle' label="实际控制人与紧急联系人关系：" prop="actualRelationShip">
                                            {{editFormListLegal.actualRelationShip}}
                                        </FormItem>
                                    </Col>
                                </Row>
                                ...
                                <Row>
                                    <Col span="24">
                                        <FormItem label="实际控制人紧急联系人地址：" prop="actualUrgencyProvinceCode">
                                            {{editFormListLegal.actualUrgencyAddressDetils}}
                                            {{editFormListLegal.actualUrgencyAddress}}
                                        </FormItem>
                                        <FormItem  label="婚姻状态：" prop="marriageState">
                                            <div v-if="editFormListLegal.marriageState == 0">
                                                未婚
                                            </div>
                                            <div v-if="editFormListLegal.marriageState == 1">
                                                已婚
                                            </div>
                                            <div v-if="editFormListLegal.marriageState == 2">
                                                离异
                                            </div>
                                        </FormItem>
                                    </Col>
                                    ...
                                    <Row>
                                        <Col span="24">
                                            <FormItem class='displayStyle setAll' label="配偶手机：" prop="actualMatePhoneNo">
                                                {{editFormListLegal.actualMatePhoneNo}}
                                            </FormItem>
                                        </Col>
                                        <Col span="24">
                                            <FormItem label="配偶联系地址：" class="setAll">
                                                {{editFormListLegal.actualMateAddressDetils}}
                                                {{editFormListLegal.actualMateAddress}}
                                            </FormItem>
                                        </Col>
                                    </Row>
                                    <Row>
            ...
            initInfo () {
                ...
                axios.all([that.getAdressInfoAll('', 'urgencyListProvince').then(res=>{}).catch(err=>{}), that.getAdressInfoAll('', 'legalListProvince').then(res=>{}).catch(err=>{}), that.getAdressInfoAll('', 'actualListProvince').then(res=>{}).catch(err=>{}), that.getAdressInfoAll('', 'actualUrgencyListProvince').then(res=>{}).catch(err=>{}), that.getAdressInfoAll('', 'actualMateListProvince').then(res=>{}).catch(err=>{})])
                    .then(axios.spread(function (...args) {
                        // that.$store.commit('setCreditCode', '');
                        that.ApplyQuery();
                    }));
            },
            // 展示隐藏图片
                                    ...
                                    vm.getAdressInfoAll(lsdGetInfo.legalProvinceCode, 'legalListCities').then(res => {
                                        if (!arr.includes(lsdGetInfo.legalCityCode)) {
                                            ...
                                            vm.getAdressInfoAll(lsdGetInfo.legalCityCode, 'legalListDistricts').then(res => {
                                                ...
                                                vm.$nextTick(()=>{
                                                    let provinceStr = publicMethod.addressName(vm.legalListProvince,lsdGetInfo.legalProvinceCode);
                                                    let cityStr = publicMethod.addressName(vm.legalListCities,lsdGetInfo.legalCityCode);
                                                    let area = ''
                                                    if (!arr.includes(lsdGetInfo.legalAreaCode)) {
                                                        area = publicMethod.addressName(vm.legalListDistricts,lsdGetInfo.legalAreaCode);
                                                    }
                                                    vm.editFormListLegal.legalAddressDetils = provinceStr + cityStr + area;
                                                });
                                    ...
                                    vm.getAdressInfoAll(lsdGetInfo.urgencyProvinceCode, 'urgencyListCities').then(res => {
                                        if (!arr.includes(lsdGetInfo.urgencyCityCode)) {
                                            ...
                                            vm.getAdressInfoAll(lsdGetInfo.urgencyCityCode, 'urgencyListDistricts').then(res => {
                                                ...
                                                vm.$nextTick(()=>{
                                                    let provinceStr = publicMethod.addressName(vm.urgencyListProvince,lsdGetInfo.urgencyProvinceCode);
                                                    let cityStr = publicMethod.addressName(vm.urgencyListCities,lsdGetInfo.urgencyCityCode);
                                                    let area = ''
                                                    if (!arr.includes(lsdGetInfo.urgencyAreaCode)) {
                                                        area = publicMethod.addressName(vm.urgencyListDistricts,lsdGetInfo.urgencyAreaCode);
                                                    }
                                                    vm.editFormListLegal.urgencyAddressDetils = provinceStr + cityStr + area;
                                                });
                                    ...
                                    vm.getAdressInfoAll(lsdGetInfo.actualProvinceCode, 'actualListCities').then(res => {
                                        if (!arr.includes(lsdGetInfo.actualCityCode)) {
                                            ...
                                            vm.getAdressInfoAll(lsdGetInfo.actualCityCode, 'actualListDistricts').then(res => {
                                                ...
                                                vm.$nextTick(()=>{
                                                    let provinceStr = publicMethod.addressName(vm.actualListProvince,lsdGetInfo.actualProvinceCode);
                                                    let cityStr = publicMethod.addressName(vm.actualListCities,lsdGetInfo.actualCityCode);
                                                    let area = ''
                                                    if (!arr.includes(lsdGetInfo.urgencyAreaCode)) {
                                                        area = publicMethod.addressName(vm.actualListDistricts,lsdGetInfo.actualAreaCode);
                                                    }
                                                    vm.editFormListLegal.actualAddressDetils = provinceStr + cityStr + area;
                                                });
                                    ...
                                    vm.getAdressInfoAll(lsdGetInfo.actualUrgencyProvinceCode, 'actualUrgencyListCities').then(res => {
                                        if (!arr.includes(lsdGetInfo.actualUrgencyCityCode)) {
                                            ...
                                            vm.getAdressInfoAll(lsdGetInfo.actualUrgencyCityCode, 'actualUrgencyListDistricts').then(res => {
                                                ...
                                                vm.$nextTick(()=>{
                                                    let provinceStr = publicMethod.addressName(vm.actualUrgencyListProvince,lsdGetInfo.actualUrgencyProvinceCode);
                                                    let cityStr = publicMethod.addressName(vm.actualUrgencyListCities,lsdGetInfo.actualUrgencyCityCode);
                                                    let area = ''
                                                    if (!arr.includes(lsdGetInfo.actualUrgencyAreaCode)) {
                                                        area = publicMethod.addressName(vm.actualUrgencyListDistricts,lsdGetInfo.actualUrgencyAreaCode);
                                                    }
                                                    vm.editFormListLegal.actualUrgencyAddressDetils = provinceStr + cityStr + area;
                                                });
                                    ...
                                    vm.getAdressInfoAll(lsdGetInfo.actualMateProvinceCode, 'actualMateListCities').then(res => {
                                        if (!arr.includes(lsdGetInfo.actualMateCityCode)) {
                                            ...
                                            vm.getAdressInfoAll(lsdGetInfo.actualMateCityCode, 'actualMateListDistricts').then(res => {
                                                ...
                                                vm.$nextTick(()=>{
                                                    let provinceStr = publicMethod.addressName(vm.actualMateListProvince,lsdGetInfo.actualMateProvinceCode);
                                                    let cityStr = publicMethod.addressName(vm.actualMateListCities,lsdGetInfo.actualMateCityCode);
                                                    let area = ''
                                                    if (!arr.includes(lsdGetInfo.actualMateAreaCode)) {
                                                        area = publicMethod.addressName(vm.actualMateListDistricts,lsdGetInfo.actualMateAreaCode);
                                                    }
                                                    vm.editFormListLegal.actualMateAddressDetils = provinceStr + cityStr + area;
                                                });
            ...
            * */
            ...
            validateImgLsd ()  {
                return new Promise((resolve, reject) => {
                    ...
                    if (vm.editFormListLegal.marriageState === '0' && vm.$refs.upload4.newListqny.length === 0) { // 离异
            ...
            submitLsdApply () {
                ...
                let _params = {
                    ...
                    urgencyPhoneNo: vm.editFormListLegal.urgencyPhoneNo, // 法人紧急联系人方���
...
// WEBPACK FOOTER //
// src/views/user/limitApply/limitApplyLegalLSDInfo.vue