                        ...
                        <Form ref="editFormList" :model="editFormList" :label-width="200" :rules="ruleValidate">
                                    ...
                                    <Row style="padding-top: 25px;">
                                        ...
                                        <Col span="24">
                                            <FormItem label="企业所在位置:" prop="enterpriseAddressProvince">
                                                {{editFormList.provice}} &nbsp; {{editFormList.city}}&nbsp;{{editFormList.area}} &nbsp; {{editFormList.dPosition}}
                                            </FormItem>
                                        </Col>
                                        <!--<Col span="24">-->
                            ...
                            <div style="padding: 16px;">
                                <dl class="apply-detail  applyUImg mt10 setAlls">
                                    <dt><span class="ml10">第二步 上传企业资质</span> <span class="fr"></span></dt>
                                    <dd style="padding-top: 20px">
                                        <FormItem label="企业营业执照：" class="top-border" style="border-top:0;display: inline-block">
                                            <file-upload
                                                    :isMultiUpload="false"
                                                    ref="uploadS1"
                                                    refUpload="uploadS1"
                                        ...
                                        <FormItem label="GSP证书：" class="top-border" style="border-top:0;display: inline-block">
                                            <file-upload
                                                    :isMultiUpload="false"
                                                    ref="uploadS2"
                                                    refUpload="uploadS2"
                                        ...
                                        <FormItem label="药品经营许可证：" class="top-border" style="border-top:0;display: inline-block">
                                            <file-upload
                                                    :isMultiUpload="false"
                                                    ref="uploadS3"
                                                    refUpload="uploadS3"
                                ...
                                <!--<div class="mt30 text-align-center tj-btn">-->
                                    <!--<Button type="primary" :disabled="btnDisabled" @click="submitYBT('editFormList')">立即申请</Button>-->
                                <!--</div>-->
                            </div>
                            <!-- 流水贷 E -->
                        </Form>
...
<script>
    ...
    import fileUpload from '../components/fileUploadImg'
                ...
                vm.$https.post('/api-webbff/v1/asset/creditApplyInfo', {
                    ...
                    .then(res => {
                        if (res.data.success === 1) {
                            ...
                            vm.editFormList.provice = ybtGetInfo.provice;
                            vm.editFormList.city = ybtGetInfo.city;
                            vm.editFormList.area = ybtGetInfo.area;
            ...
            submitYBT (name) {
                ...
                this.$nextTick(() => {
                    ...
                    let _params = {
                        ...
                        proviceCode: vm.editFormList.enterpriseAddressProvince, // 客户企业所在的省份编码
                        cityCode: vm.editFormList.enterpriseAddressCity, // 客户企业所在的市编码
                        areaCode: vm.editFormList.enterpriseAddressCountry, // 客户企业所在区域编码
                        ...
                        socialUnifiedCreditPicUrl_rgt: vm.$refs.uploadS1.newListRgt.join(','), // 营业执照-融贯通
                        enterpriseInfoMd5: vm.editFormList.enterpriseInfoMd5
                    };
                    vm.btnDisabled = true;
                    vm.$refs[name].validate((valid) => { // 注：提交成功 但融贯通接口返回598
                        if (valid) {
                            // vm.$https.post('http://192.168.19.126:3000/mock/22/v1/asset/productCreditApplyForYBT' , _params).then(res => {
...
// WEBPACK FOOTER //
// src/views/user/limitApply/limitApplyYBTInfo.vue