                ...
                <div>
                    <div style="padding: 0 15px;">
                        ...
                        <shareholder-info
                                ...
                                @isHaveSubShareholders = 'isHaveSubShareholders'>
                        </shareholder-info>
                        <!-- 填写股东信息 E -->
                    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            isHaveSubShareholders (isPass,name) {
                this.isPassNext = isPass;
            ...
            * */
            ...
            validatePassLsd (name) {
                if (this.isPassNext) {
                    ...
                    vm.$message.error('请添加' + this.shareholderName + '的股东的股东信息');
                }
            },
            /**
             * 返回
...
// WEBPACK FOOTER //
// src/views/user/limitApply/limitApplyShareholderLSD.vue